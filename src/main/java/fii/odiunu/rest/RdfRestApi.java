...
public class RdfRestApi {
    ...
    public ResponseEntity<String> getMenuToHTML() {
        ...
        rdfLocalManager.writeMenuToFuseki("7", "15  min", "breakfast", "turkey meat", "Turkey Breakfast Sausage", "941135.jpg", "You can use this recipe for chicken and pork as well.", "2 pounds ground turkey 1 tablespoon brown sugar 2 teaspoons kosher salt 1 1/2 teaspoons ground black pepper 1 1/2 teaspoons ground sage 1 1/2 teaspoons ground thyme 1/2 teaspoon dried marjoram 1/2 teaspoon red pepper flakes", "USA");


        rdfLocalManager.writeMenuToFuseki("8", "10 min", "dinner", "dessert", "Bee Sting Cake (Bienenstich) II", "270399.jpg", "It is bread like with a sugary-almond crunchy crust and a vanilla pudding filling", " 1 5/8 cups all-purpose flour 1 tablespoon active dry yeast 2 tablespoons white sugar 1 pinch salt 3/4 cup lukewarm milk 3 tablespoons butter 3 tablespoons butter 1 1/2 tablespoons confectioners' sugar 1 tablespoon milk 5/8 cup sliced almonds 1 tablespoon honey (optional) 1 1/2 cups milk 1/3 cup cornstarch 1 tablespoon white sugar 1 egg, beaten 1 teaspoon almond extract 1 cup heavy whipping cream 1/2 tablespoon cream of tartar", "Romania");
        rdfLocalManager.writeMenuToFuseki("9", "8 min", "breakfast", "dessert", "Clatite", "270399.jpg", "Three Buttermilk Pancakes loaded with pecans and served with real butter and a warm bottle of syrup.", "3 eggs, 1/2 kg flour, 5 spoons of sugar, honey", "United States");
